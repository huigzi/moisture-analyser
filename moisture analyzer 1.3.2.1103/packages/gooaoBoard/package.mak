...
package/%.xdc.inc package/%_gooaoBoard.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package gooaoBoard" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedgooaoBoardpackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js gooaoBoard $@
...
.PHONY: release,gooaoBoard
gooaoBoard.zip: package/package.bld.xml
gooaoBoard.zip: package/build.cfg
gooaoBoard.zip: package/package.xdc.inc
gooaoBoard.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/gooaoBoard.zip.dep
endif
package/rel/gooaoBoard/gooaoBoard/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

gooaoBoard.zip: package/rel/gooaoBoard.xdc.inc package/rel/gooaoBoard/gooaoBoard/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/gooaoBoard.xdc.inc,package/rel/gooaoBoard.zip.dep)


release release,gooaoBoard: all gooaoBoard.zip
clean:: .clean
	-$(RM) gooaoBoard.zip
	-$(RM) package/rel/gooaoBoard.xdc.inc
	-$(RM) package/rel/gooaoBoard.zip.dep
