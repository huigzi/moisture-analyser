...
package/%.xdc.inc package/%_fr_Board.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package fr_Board" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedfr_Boardpackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js fr_Board $@
...
.PHONY: release,fr_Board
fr_Board.zip: package/package.bld.xml
fr_Board.zip: package/build.cfg
fr_Board.zip: package/package.xdc.inc
fr_Board.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/fr_Board.zip.dep
endif
package/rel/fr_Board/fr_Board/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

fr_Board.zip: package/rel/fr_Board.xdc.inc package/rel/fr_Board/fr_Board/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/fr_Board.xdc.inc,package/rel/fr_Board.zip.dep)


release release,fr_Board: all fr_Board.zip
clean:: .clean
	-$(RM) fr_Board.zip
	-$(RM) package/rel/fr_Board.xdc.inc
	-$(RM) package/rel/fr_Board.zip.dep
