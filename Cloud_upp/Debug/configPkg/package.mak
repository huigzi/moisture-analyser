...
C:/Users/tysh0/workspace/Cloud_upp/packages/fr_Board/config.bld:
package.mak: C:/Users/tysh0/workspace/Cloud_upp/packages/fr_Board/config.bld
...
.dlls,e674 .dlls: gooao_fr_c6748.pe674

-include package/cfg/gooao_fr_c6748_pe674.mak
-include package/cfg/gooao_fr_c6748_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/gooao_fr_c6748_pe674.dep
endif
gooao_fr_c6748.pe674: package/cfg/gooao_fr_c6748_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
gooao_fr_c6748.pe674 package/cfg/gooao_fr_c6748_pe674.c: .libraries,e674
endif

package/cfg/gooao_fr_c6748_pe674.c package/cfg/gooao_fr_c6748_pe674.h package/cfg/gooao_fr_c6748_pe674.xdl: override _PROG_NAME := gooao_fr_c6748.xe674
package/cfg/gooao_fr_c6748_pe674.c: package/cfg/gooao_fr_c6748_pe674.cfg

clean:: clean,e674
	-$(RM) package/cfg/gooao_fr_c6748_pe674.cfg
	-$(RM) package/cfg/gooao_fr_c6748_pe674.dep
	-$(RM) package/cfg/gooao_fr_c6748_pe674.c
	-$(RM) package/cfg/gooao_fr_c6748_pe674.xdc.inc

clean,e674::
	-$(RM) gooao_fr_c6748.pe674
.executables,e674 .executables: gooao_fr_c6748.xe674

gooao_fr_c6748.xe674: |gooao_fr_c6748.pe674

-include package/cfg/gooao_fr_c6748.xe674.mak
gooao_fr_c6748.xe674: package/cfg/gooao_fr_c6748_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/gooao_fr_c6748_pe674.oe674   package/cfg/gooao_fr_c6748_pe674.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/rts6740_elf.lib
	
gooao_fr_c6748.xe674: export C_DIR=
gooao_fr_c6748.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
gooao_fr_c6748.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

gooao_fr_c6748.test test,e674 test: gooao_fr_c6748.xe674.test

gooao_fr_c6748.xe674.test:: gooao_fr_c6748.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 gooao_fr_c6748.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.gooao_fr_c6748.xe674, ) 
endif

clean,e674::
	-$(RM) .tmp,gooao_fr_c6748.xe674,0,*


clean:: clean,e674

clean,e674::
	-$(RM) gooao_fr_c6748.xe674
clean:: 
	-$(RM) package/cfg/gooao_fr_c6748_pe674.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
gooao_fr_c6748_pe674.oe674,copy : package/cfg/gooao_fr_c6748_pe674.oe674
gooao_fr_c6748_pe674.se674,copy : package/cfg/gooao_fr_c6748_pe674.se674
