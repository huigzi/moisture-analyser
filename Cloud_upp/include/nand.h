 ...
 *
 * Header file for the generic low-level NAND driver code for use with the
 * DaVinci EMIFA peripheral
 *
...
extern NAND_InfoHandle NAND_open(Uint32 baseCSAddr);
