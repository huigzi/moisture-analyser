...
typedef enum _DEVICE_BootMode_
{
  ...
  DEVICE_BOOTMODE_MMC_SD  = 0x2,    // SD card
...
#define DEVICE_DDR2_RAM_SIZE        (0x04000000u)

#define DEVICE_MAX_IMAGE_SIZE       (0x02000000u)
#define DEVICE_DDR2_START_ADDR      (0xC0000000u)
...
#define AEMIF ((DEVICE_EmifRegs*) 0x68000000)
...
#define DEVICE_EMIF_NANFCR_4BITECC_START_MASK           (0x00001000)
#define DEVICE_EMIF_NANFCR_4BITECC_START_SHIFT          (12)
#define DEVICE_EMIF_NANFCR_4BITECC_ADD_CALC_START_MASK  (0x00002000)
#define DEVICE_EMIF_NANFCR_4BITECC_ADD_CALC_START_SHIFT (13)
