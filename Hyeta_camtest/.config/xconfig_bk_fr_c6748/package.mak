...
override PKGDIR = xconfig_bk_fr_c6748
...
C:/Users/tysh0/workspace/Hyeta_camtest/packages/fr_Board/config.bld:
package.mak: C:/Users/tysh0/workspace/Hyeta_camtest/packages/fr_Board/config.bld
...
package/%.xdc.inc package/%_xconfig_bk_fr_c6748.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_bk_fr_c6748" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e674 .dlls: bk_fr_c6748.pe674

-include package/cfg/bk_fr_c6748_pe674.mak
-include package/cfg/bk_fr_c6748_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/bk_fr_c6748_pe674.dep
endif
bk_fr_c6748.pe674: package/cfg/bk_fr_c6748_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
bk_fr_c6748.pe674 package/cfg/bk_fr_c6748_pe674.c: .libraries,e674
endif

package/cfg/bk_fr_c6748_pe674.c package/cfg/bk_fr_c6748_pe674.h package/cfg/bk_fr_c6748_pe674.xdl: override _PROG_NAME := bk_fr_c6748.xe674
package/cfg/bk_fr_c6748_pe674.c: package/cfg/bk_fr_c6748_pe674.cfg

clean:: clean,e674
	-$(RM) package/cfg/bk_fr_c6748_pe674.cfg
	-$(RM) package/cfg/bk_fr_c6748_pe674.dep
	-$(RM) package/cfg/bk_fr_c6748_pe674.c
	-$(RM) package/cfg/bk_fr_c6748_pe674.xdc.inc

clean,e674::
	-$(RM) bk_fr_c6748.pe674
.executables,e674 .executables: bk_fr_c6748.xe674

bk_fr_c6748.xe674: |bk_fr_c6748.pe674

-include package/cfg/bk_fr_c6748.xe674.mak
bk_fr_c6748.xe674: package/cfg/bk_fr_c6748_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/bk_fr_c6748_pe674.oe674   package/cfg/bk_fr_c6748_pe674.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/rts6740_elf.lib
	
bk_fr_c6748.xe674: export C_DIR=
bk_fr_c6748.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
bk_fr_c6748.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

bk_fr_c6748.test test,e674 test: bk_fr_c6748.xe674.test

bk_fr_c6748.xe674.test:: bk_fr_c6748.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 bk_fr_c6748.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.bk_fr_c6748.xe674, ) 
endif

clean,e674::
	-$(RM) .tmp,bk_fr_c6748.xe674,0,*


clean:: clean,e674

clean,e674::
	-$(RM) bk_fr_c6748.xe674
clean:: 
	-$(RM) package/cfg/bk_fr_c6748_pe674.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
bk_fr_c6748_pe674.oe674,copy : package/cfg/bk_fr_c6748_pe674.oe674
bk_fr_c6748_pe674.se674,copy : package/cfg/bk_fr_c6748_pe674.se674

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_bk_fr_c6748
xconfig_bk_fr_c6748.tar: package/package.bld.xml
xconfig_bk_fr_c6748.tar: package/build.cfg
xconfig_bk_fr_c6748.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_bk_fr_c6748.tar.dep
endif
package/rel/xconfig_bk_fr_c6748/xconfig_bk_fr_c6748/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_bk_fr_c6748.tar: package/rel/xconfig_bk_fr_c6748.xdc.inc package/rel/xconfig_bk_fr_c6748/xconfig_bk_fr_c6748/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_bk_fr_c6748.xdc.inc,package/rel/xconfig_bk_fr_c6748.tar.dep)


release release,xconfig_bk_fr_c6748: all xconfig_bk_fr_c6748.tar
clean:: .clean
	-$(RM) xconfig_bk_fr_c6748.tar
	-$(RM) package/rel/xconfig_bk_fr_c6748.xdc.inc
	-$(RM) package/rel/xconfig_bk_fr_c6748.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_bk_fr_c6748.pjt
