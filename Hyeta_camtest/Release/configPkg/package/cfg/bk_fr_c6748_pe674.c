...
/* Object__table__V */
ti_sysbios_io_DEV_Object__ ti_sysbios_io_DEV_Object__table__V[2];
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[5692];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/tysh0/workspace/Hyeta_camtest/Release/configPkg/package/cfg/bk_fr_c6748_pe674");
...
/* Object__count__C */
__FAR__ const CT__ti_sysbios_io_DEV_Object__count ti_sysbios_io_DEV_Object__count__C = 2;
...
/* charCnt__C */
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x163c;
